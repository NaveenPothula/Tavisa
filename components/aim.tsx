...
export default function Aim() {
  return (
    <div className="px-0 bg-white">
      {/* Main Heading */}
      <h1 className="text-center md:text-3xl text-xl font-bold text-yellow-500 md:mb-6 mb-2">
        Ayurveda’s aim is to bring the body into balance
      </h1>

      {/* Main Description */}
      <p className="text-center text-lg text-gray-700 md:mb-4 mb-2">
      ...
      <p className="text-center text-lg text-gray-700 md:mb-4 mb-2 md:px-10">

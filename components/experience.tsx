      ...
      <div className="flex flex-col md:flex-row bg-white">
        ...
        <div className="flex-1 bg-white flex justify-center h-auto">
          <div className="text-left">
            ...
            <h2 className="md:text-2xl text-xl font-bold mb-6 text-yellow-500">
            ...
            <Link
              href="/symptoms"
              className="bg-pink-500 text-white px-2 py-2 rounded-full mx-auto hover:bg-blue-600" // Adjusted padding
            >

  ...
  return (
    <div>
      ...
      >
        ...
        <div className="h-[300px] md:h-[400px] w-full relative">
          ...
          <div className="hidden md:flex md:flex-col items-center justify-center absolute top-0 left-[50%] w-[50%] h-full items-center px-4">
            <p className="text-black text-2xl text-center mb-2">
      ...
      <div className="md:hidden flex flex-col justofy-center items-center">
        <p className="text-black text-xl text-center font-semibold mb-2">
        ...
        <Link
          href="/what-next"
          className="bg-pink-500 text-white px-2 py-2 rounded-full hover:bg-blue-600 mt-2 mb-6" // Adjusted padding
        >
          What Next?
        </Link>
      </div>
